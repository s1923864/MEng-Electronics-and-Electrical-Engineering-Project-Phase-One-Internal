function [real_CMC_array,imag_CMC_array] = cross_memory_capacity(initial_k,end_k,rep)
    ...
    for i = initial_k : end_k
        for r = 1:rep
            ...
            for l = 1:5
                ...
                real_CMC_array(l,i-initial_k+1) = real_CMC_array(l,i-initial_k+1) + R_square(real(y_test(r,:)'),real(prediction))/(100*rep);
                imag_CMC_array(l,i-initial_k+1) = imag_CMC_array(l,i-initial_k+1) + R_square(imag(y_test(r,:)'),imag(prediction))/(100*rep);
            end

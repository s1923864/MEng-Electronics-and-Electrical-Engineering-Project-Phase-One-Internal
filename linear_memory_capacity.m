function [real_LMC_array,imag_LMC_array] = linear_memory_capacity(initial_k,end_k,rep)
    ...
    for i = initial_k : end_k
        for r = 1:rep
            ...
            for l = 1:5
                ...
                real_LMC_array(l,i-initial_k+1) = real_LMC_array(l,i-initial_k+1) + R_square(real(y_test(r,:)'),real(prediction))/(100*rep);
                imag_LMC_array(l,i-initial_k+1) = imag_LMC_array(l,i-initial_k+1) + R_square(imag(y_test(r,:)'),imag(prediction))/(100*rep);
            end
